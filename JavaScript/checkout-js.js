        ...
        checkout.shippingMethod = function () {
            ...
            if (city === true) {
                if (shoppingCart.totalCart() > 599) {
                    ...
                    overNightDeliveryPrice.innerText = "99.00";
                    overNightDeliveryInput.setAttribute("value", "99");
                } else {
                    standardDeliveryPrice.innerText = "69.00";
                    standardDeliveryInput.setAttribute("value", "69");
                    overNightDeliveryPrice.innerText = "129.00";
                    overNightDeliveryInput.setAttribute("value", "129");
                }
            } else {
                standardDeliveryPrice.innerText = "0.00";
                standardDeliveryInput.setAttribute("value", "0.00");
                overNightDeliveryPrice.innerText = "249.00";
